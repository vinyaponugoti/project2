    ...
    if not os.path.exists(output_csv_path):
        ...
        with open(output_csv_path, "w", newline="") as csv_file:
            ...
            for test_img in test_dataset_images:
                ...
                model = load_model(
                    "models/model_4.h5"
                )  # file path may need to be changed if we put model in a different path
...
save_test_results("well_lit_test_set", "well_lit_random_contrast_results.csv")

save_test_results("black_and_white_test_set", "black_white_random_contrast_results.csv")

save_test_results("low_contrast_test_set", "low_contrast_random_contrast_results.csv")
